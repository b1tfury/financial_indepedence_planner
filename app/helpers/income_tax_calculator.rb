class IncomeTaxCalculator
  ...
  def get_tax
    if @total_income <= MAX_NON_TAXABLE_INCOME_AMOUNT
      ...
      surcharge_tax_on_income_tax_amount_range_1C_and_2C = income_tax_amount_eligible_for_surcharge_tax_2 * SURCHARGE_TAX_RATE_FOR_INCOME_RANGE_1C_AND_2C

      max_income_tax_in_tax_slab_1 + max_income_tax_in_tax_slab_2 + income_tax_for_tax_slab_3 + surcharge_tax_on_income_tax_amount_for_range_50L_and_1C + surcharge_tax_on_income_tax_amount_range_1C_and_2C
    end
  end
